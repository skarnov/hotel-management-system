                            ...
                            <div class="row">                   
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="header">
                                            <h4 class="title">Expense Manager</h4>
                                            <p class="category">Here is you can manage your Expenses</p>
                                        </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['expense_time'] ?></td>
                                                            <td><?php echo $row['expense_paid_amount'] ?></td>
                                                            <td>
                                                                <a href="../function/delete_expense.php?id=<?php echo $row['expense_id'] ?>" class="btn btn-danger" data-toggle="tooltip" title="Delete Expense" onclick="return check_delete();"><i class="fa fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
