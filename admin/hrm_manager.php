                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <ol class="breadcrumb">
                                            ...
                                            <li><a href="add_employee.php"><i class="fa fa-globe"></i> Add New Employee</a></li>
                                            <li class="active">Employee Manager</li>
                                        </ol>
                                        <div class="header">
                                            <h4 class="title">Employee Manager</h4>
                                            <p class="category">Here is you can manage your Employees</p>
                                        </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="edit_employee.php?id=<?php echo $row['employee_id'] ?>" class="btn btn-primary" data-toggle="tooltip" title="Edit Employee"><i class="fa fa-pencil-square-o"></i></a>
                                                                <a href="../function/delete_employee.php?id=<?php echo $row['employee_id'] ?>" class="btn btn-danger" data-toggle="tooltip" title="Delete Employee" onclick="return check_delete();"><i class="fa fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
