<?php
    ...
    if(isset($_FILES['room_image'])){
        ...
        $file_ext=strtolower(end(explode('.',$_FILES['room_image']['name'])));
        ...
        if(empty($errors)==true){
           move_uploaded_file($file_tmp,"upload/room_image/".$file_name);
              $sql = "INSERT INTO tbl_room (room_name, room_image, room_description, room_price, room_amount)
                  VALUES ('$room_name', 'upload/room_image/$file_name', '$room_description', '$room_price','$room_amount')";
        }else{
           print_r($errors);
        }
    }
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="room_amount" class="form-control">
                                                    </div>        
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-info btn-fill">Save Room</button>
