<?php
    ...
    $sql = "SELECT * FROM tbl_booking AS b, tbl_room AS r, tbl_user AS u WHERE b.room_id=r.room_id AND b.user_id=u.user_id";
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active">Booking Manager</li>
                                        </ol>
                                        <div class="header">
                                            <h4 class="title">Booking Manager</h4>
                                            <p class="category">Here is you can manage your Room Bookings</p>
                                        </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="../function/delete_booking.php?id=<?php echo $row['booking_id'] ?>" class="btn btn-danger" data-toggle="tooltip" title="Delete Booking" onclick="return check_delete();"><i class="fa fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
