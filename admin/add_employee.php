<?php
    ...
    $sql = "INSERT INTO tbl_employee (employee_name, employee_designation, employee_salary, employee_mobile_number)
        VALUES ('$employee_name', '$employee_designation', '$employee_salary', '$employee_mobile_number')";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <ol class="breadcrumb">
                                        ...
                                        <li><a href="hrm_manager.php"><i class="fa fa-globe"></i> Manage Employees</a></li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="employee_designation" class="form-control"></textarea>
                                                    </div>        
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <label>Mobile</label>
                                                        <input type="number" name="employee_mobile_number" class="form-control">
                                                    </div>        
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-info btn-fill">Save Employee</button>
