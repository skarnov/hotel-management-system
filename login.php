        ...
        <div class="contact">
            <div class="container">
                <div class="contact-top heading">
                    <h3>Evis Hotel Login</h3><br/>
                    <p>For hotel room booking you have to login. If don't have login ID, you can <a href="signup.php">Signup</a> Here</p>
                </div>
                <div class="contact-bottom">
                    <form action="../evis_hotel_management_system/function/user_login.php" method="POST">
